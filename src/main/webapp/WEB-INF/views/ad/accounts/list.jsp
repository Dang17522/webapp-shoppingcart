		...
		<section class="row">
			<div class="col mt-4">
				<div class="card">
					...
					<div class="col-4"><h2>List of Accounts</h2></div>
						<div class="col-2"><c:if test="${sessionScope.admin==true}">
							<a href="admin/accounts/add" class="btn btn-outline-dark">Add Account</a>
						</c:if></div>
					...
					<div class="card-body">		
						<table class="table table-striped table-inverse">
							...
							<c:forEach var="account" items="${accounts}">
									...
									<td><a href="/admin/accounts/view/${account.username}"
