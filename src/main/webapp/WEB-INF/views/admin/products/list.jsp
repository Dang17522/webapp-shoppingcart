...
<body>
	...
	<div class="container-fuild">
		<div class="container">
			...
			<section class=" row" style="background-color: #FFEFD5	">
									...
									<a href="/products/edit/${product.productid}"
										...
										<div class="card-body">
											...
											<p class="card-text"
												...
												${product.unitprice} $</p>
											<a href="/products/addcart2/${product.productid}"
												class="btn btn-primary mt-1" style="margin-left: 35px;">Đặt
												hàng ngay</a> <a href="/products/addcart/${product.productid}"
							...
							<div class="card-header" id="headingTwo">
								<h2 class="mb-0">
									<button class="btn btn-link btn-block text-left collapsed"
										...
										aria-controls="collapseTwo">Sản phẩm giảm giá</button>
								</h2>
							</div>
			...
			<form action="/products/home" method="get">
				<br />
				<div class="form-group col-md-12" style="background-color: #FAFAD2; height: 60px">

					<button class="btn btn-outline-success" name="page" value="1"
						onchange="this.form.submit()"
						style="width: 60px; margin-left: 270px; margin-top: 12px"><<</button>

					<button class="btn btn-outline-danger" name="page"
						value="${productpage.number - 0}"
						style="width: 60px; margin-left: 20px; margin-top: 12px"
